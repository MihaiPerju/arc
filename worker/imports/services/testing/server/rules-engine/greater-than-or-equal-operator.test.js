...
describe("Rules Engine", function() {
  it("Should Recognise  Greater than or Equal to Operator on Discharge Date ", function() {
    const rule = {
      data: {
        combinator: "AND",
        deName: "1",
    ...
    chai.assert(
      RulesEngine.evaluate(account, rule) &&
        RulesEngine.evaluate(anotherAccount, rule)
    );
  });
});

describe("Rules Engine", function() {
  it("Should Recognise  Greater than or Equal to Operator on Last Bill Date ", function() {
    const rule = {
      data: {
        combinator: "AND",
        deName: "1",
...
describe("Rules Engine", function() {
  it("Should Recognise  Greater than or Equal to Operator on Account Balance ", function() {
    const rule = {
      data: {
        combinator: "AND",
        deName: "1",
...
describe("Rules Engine", function() {
  it("Should Recognise  Greater than or Equal to Operator on Admit Date ", function() {
    const rule = {
      data: {
        combinator: "AND",
        deName: "1",
...
describe("Rules Engine", function() {
  it("Should Recognise  Greater than or Equal to Operator on Tickle Date ", function() {
    const rule = {
      data: {
        combinator: "AND",
        deName: "1",
...
describe("Rules Engine", function() {
  it("Should Recognise  Greater than or Equal to Operator on Medical Number ", function() {
    const rule = {
      data: {
        combinator: "AND",
        deName: "1",

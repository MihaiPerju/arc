        ...
        return (
            <div className="action-block">
                ...
                <div className="main__block">
                    ...
                    {this.state.createLetter ? <NewLetter cancel={this.toggleLetter.bind(this)} account={account}/> : null}
                                    ...
                                    <div key={index} className="block-item">
                                        ...
                                        <div className="btn-group">
                                            <button
                                                ...
                                                onClick={this.redirectToPdf.bind(this, `${account._id}/${letter._id}/${getToken()}`)}
                                            >

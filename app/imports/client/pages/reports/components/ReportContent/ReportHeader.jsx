                                ...
                                <div className="table-row">
                                    {
                                        tableHeader.map(function (header, index) {
                                            return (
                                                (index == 0) ? (
                                                    <div
                                                        className="table-header truncate text-left table-field table-field--fixed text-light-grey">
                                                        {header}
                                                    </div>
                                                ) : (
                                                    <div key={index}
                                    ...
                                    accounts.map((account, index) => {
                                        return (
                                            <div className="table-row" key={index}>
                                                <div
                                                    className="table-field table-field--fixed truncate text-center">
                                                    {'Account No.' + (index + 1)}
                                                </div>

                                                <div className="table-field table-field--grey text-center">{account.acctNum}</div>
                                                <div className="table-field table-field--grey text-center">
                                                    {moment(account.dischrgDate).format("MM/DD/YYYY hh:mm")}
                                                </div>
                                                <div className="table-field table-field--grey text-center">{account.ptType}</div>
                                                <div className="table-field table-field--grey text-center">{account.facCode}</div>
                                                <div className="table-field table-field--grey text-center">{account.ptName}</div>
                                                <div className="table-field table-field--grey text-center">
                                                    {moment(account.fbDate).format("MM/DD/YYYY hh:mm")}
                                                </div>
                                                <div className="table-field table-field--grey text-center">{account.acctBal}</div>
                                                <div className="table-field table-field--grey text-center">{account.finClass}</div>
                                                <div className="table-field table-field--grey text-center">
                                                    {moment(account.admitDate).format("MM/DD/YYYY hh:mm")}
                                                </div>
                                                <div className="table-field table-field--grey text-center">{account.medNo}</div>
                                            </div>
                                        )
                                    })
                                }

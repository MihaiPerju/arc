...
export default class UserSingle extends Component {
  ...
  render() {
    const { user, setUser, usersSelected, open, moduleTags } = this.props;
    ...
    const model = {
      markerIds: user.markerIds
    };

    return (
      <div className={classes} onClick={this.setUser.bind(this)}>
        <div className="check-item">
          <input
            ...
            className="hidden"
          />
          <label onClick={this.onSelectUser.bind(this)} />

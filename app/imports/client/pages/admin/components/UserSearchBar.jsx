...
export default class SearchBar extends Component {
    ...
    onHandleChange(field, value) {
        if (field === 'email') {
            FlowRouter.setQueryParams({ email: value });
        }
    }
                    ...
                    <div className="search-bar__wrapper">
                        ...
                        <div className={btnGroup ? 'search-input' : 'search-input full__width'}>
                            <div className="form-group">
                                <AutoField labelHidden={true} name="email" placeholder="Search" />
                            </div>
                        </div>
    ...
    render() {
        ...
        return (
            <div className={this.state.in ? 'btn-group in' : 'btn-group'}>
                ...
                {
                    dialogIsActive && (
                        <Dialog title="Confirm" className="account-dialog" closePortal={this.closeDialog}>

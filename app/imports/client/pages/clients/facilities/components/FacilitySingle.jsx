...
import { getFacilityImagePath } from "../../../../../api/utils";
...
export default class FacilitySingle extends Component {
  ...
  render() {
    ...
    return (
      <div className={classes} onClick={this.onSetFacility.bind(this)}>
        <div className="check-item">
          <input checked={checked} type="checkbox" className="hidden" />
          <label onClick={this.onSelectFacility.bind(this)} />
        </div>
        <div className="row__block align-center">
          ...
          <img
            src={
              facility.logoPath
                ? getFacilityImagePath(facility.logoPath)

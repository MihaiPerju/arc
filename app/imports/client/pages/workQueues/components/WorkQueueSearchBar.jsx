...
export default class WorkQueueSearchBar extends Component {
  constructor() {
    super();
    this.state = {
      active: false,
  ...
  onSubmit(params) {
    if (
      ...
      "workQueueName" in params
    ) {
      this.props.setPagerInitial();
    }
    if ("workQueueName" in params) {
      FlowRouter.setQueryParams({ workQueueName: params.workQueueName });
    }
  }
...
const schema = new SimpleSchema({
  workQueueName: {
    type: String,
    optional: true,
    label: "Search by Work Queue Name"
  }
});

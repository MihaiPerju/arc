...
Meteor.methods({
  ...
  "accountsAssigned.get"(clientId, facilityId, assigneeId, dateRangeFilter) {
    ...
    if (clientId && clientId != "-1") filter["clientId"] = clientId;

    if (facilityId && facilityId != "-1") filter["facilityId"] = facilityId;

    if (assigneeId && assigneeId != "-1") filter["assigneeId"] = assigneeId;
  ...
  async "account.getAssignedPerHour"(
    clientId,
    facilityId,
    assigneeId,
    dateRangeFilter
  ...
  async "account.getHoldAccountsPerHour"(
    clientId,
    facilityId,
    assigneeId,
    dateRangeFilter
